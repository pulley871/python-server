...
from employees import get_all_employees, get_single_employee, post_employee, delete_employee, update_employee
from locations import get_all_locations, get_single_location, post_location, delete_location, update_location
from customers import get_all_customers, get_single_customer, post_customer, delete_customer, update_customer
